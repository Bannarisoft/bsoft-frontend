...
interface CreateMiscPropTypes {
  ...
  SublocationInput: subLocationProps;
}
      ...
      >
        <Box className="popup-header-wrapper">
          <h2 className="dialog-header">
            {editFlag ? "Edit  Sub Location" : "Create  Sub Location"}
          </h2>
          <IoClose
            fontSize={24}
            onClick={close}
          ...
          <Grid2 container spacing={2}>
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <MuiInputField
                    {...params}
                    name="departmentId"
                    value={SublocationInput.departmentId}
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <MuiInputField
                    {...params}
                    name="locationName"
                    value={SublocationInput.locationId}
                    error={error.includes("locationId")}
                    helperText={
                      error.includes("locationId") && "please select a location"
                    }
                  />
                )}
              />
            ...
            <Grid2 size={6}>
              <FormControl fullWidth>
                ...
                <MuiInputField
                  ...
                  autoComplete="off"
                  disabled={editFlag}
                  value={SublocationInput.code.toUpperCase()}
            ...
            <Grid2 size={6}>
              <FormControl fullWidth>
                ...
                <MuiInputField
                  ...
                  autoComplete="off"
                  value={SublocationInput.subLocationName}
                  onChange={handleChange}
                  error={error.includes("subLocationName")}
                  helperText={
                    error.includes("subLocationName") &&
                    "please enter valid  sub location name "
                  }
                />
              </FormControl>
            </Grid2>
            <Grid2 size={12}>
              ...
              <MuiInputField
                ...
                size="small"
                name="description"
                value={SublocationInput.description}
        ...
        >
          ...
          >
            <MuiSwitch
              checked={SublocationInput.isActive === 1}
