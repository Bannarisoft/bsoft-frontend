...
function ScheduleReport({
  ...
  const columnData: ColDef[] = useMemo(
    () => [
      ...
      {
        field: "productionDepartmentName",
      ...
      },
      {
        ...
        headerName: "Last Completion Date",
        valueFormatter: (p) =>
          p.value ? new Date(p.value).toLocaleDateString("en-GB") : "-",
      },
      {
...

      {
        ...
        headerName: "Work Order Document No",
        hide: true,
      },
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <RefreshReport value="schedule" refresh={refresh} />
      </Box>
      <Paper elevation={3}>
        <div
